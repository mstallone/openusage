...
final class AntigravityQuotaSummaryTests: XCTestCase {
    ...
    func testWrappedAndBarePayloadsProduceIdenticalFourLines() {
        ...
        XCTAssertEqual(resetsAt(lines[0]), RunwayISO8601.date(from: "2026-07-02T16:00:00Z"))
        XCTAssertEqual(resetsAt(lines[2]), RunwayISO8601.date(from: "2026-07-02T15:30:00Z"))
