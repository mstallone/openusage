...
final class GrokAuthStoreTests: XCTestCase {
    func testReadsTokenExpiryFromJWT() {
        let store = GrokAuthStore(now: { RunwayISO8601.date(from: "2026-02-02T00:00:00.000Z")! })
    ...
    func testSaveRefusesToOverwriteACorruptAuthFile() throws {
        ...
        let store = GrokAuthStore(files: files, now: { RunwayISO8601.date(from: "2026-02-02T00:00:00.000Z")! })
