...
- **"Antigravity login found in Keychain"** — the item is there but Runway isn't approved to read it yet. Refresh manually and choose **Always Allow** when macOS asks. Automatic refreshes never open the password dialog themselves.
