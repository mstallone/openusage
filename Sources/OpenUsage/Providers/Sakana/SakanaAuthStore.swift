...
enum SakanaAuthError: Error, LocalizedError, Equatable {
    ...
    var errorDescription: String? {
        ...
        case .permissionRequired:
            return "Allow OpenUsage to read your browser's Safe Storage key in Keychain, then refresh again. Choose Always Allow to permit automatic updates."
        case .credentialsUnreadable:
...
/// read-only, the decrypted token exists only in memory, and OpenUsage never refreshes or mutates it.
