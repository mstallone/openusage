...
extension Bundle {
    /// The bundle carrying Runway's copied resources (provider SVGs, pricing supplement + snapshots).
    ///
    ...
    static let runwayResources: Bundle = {
        let bundleName = "Runway_Runway.bundle"
        ...
        for case let base? in searchBases {
            ...
            if isValidRunwayResourceBundle(bundle) {
                return bundle
            }
...
/// Sentinel check: a valid Runway resource bundle carries the bundled pricing supplement at its
...
private func isValidRunwayResourceBundle(_ bundle: Bundle) -> Bool {
