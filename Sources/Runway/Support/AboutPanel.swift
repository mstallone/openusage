...
/// Presents the standard macOS About panel for the footer menu's "About Runway" item.
///
/// As a menu-bar accessory app, Runway is not the active app while the popover is showing, so the
...
enum AboutPanel {
    ...
    private static var credits: NSAttributedString {
        ...
        credits.append(link("GitHub", "https://github.com/mstallone/runway", base: base))
        return credits
    }
