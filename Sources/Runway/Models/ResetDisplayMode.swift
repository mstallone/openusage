...
/// ("Resets in 4d 17h") or a concrete wall-clock time ("Resets tomorrow at 9:00 AM"). Toggled by
/// clicking any reset label. The labels avoid relative/absolute jargon: they're what each mode
/// looks like.
