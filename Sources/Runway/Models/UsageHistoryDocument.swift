...
struct UsageHistoryDocument: Hashable, Sendable, Codable, Identifiable {
    ...
    /// same-card-id merge); v1 readers reject v2 documents with their designed "update Runway"
    /// message.
    static let currentSchema = "runway.history.v2"
    static let legacySchemaV1 = "runway.history.v1"
...
enum UsageHistoryDocumentError: Error, LocalizedError, Equatable {
    ...
    var errorDescription: String? {
        switch self {
        case .unsupportedSchema: "This Mac wrote a newer usage-history format. Update Runway."
