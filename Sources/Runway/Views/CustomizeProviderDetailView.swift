...
struct CustomizeProviderDetailView: View {
    ...
    private func emptyDropZone(providerID: String) -> some View {
        ...
        return RoundedRectangle(cornerRadius: 8, style: .continuous)
            ...
            .reorderFrame(id: expandedDividerID(for: providerID), in: reorderSpaceName, store: rowFrames, yOutset: yOutset)
    ...
    private func metricRow(_ metric: WidgetDescriptor, in providerID: String) -> some View {
        ...
        return CustomizeMetricRow(
            ...
            handle: { grip in
                AnyView(grip.reorderFrame(id: "grip:\(metric.id)", in: reorderSpaceName, store: rowFrames))
            },
            trailing: {
        ...
        .reorderFrame(id: metric.id, in: reorderSpaceName, store: rowFrames)
    }
...
private struct CardNameSection: View {
    ...
    private var record: ProviderAccountRecord? {
        container.accounts.record(backingCardID: providerID)
    }
