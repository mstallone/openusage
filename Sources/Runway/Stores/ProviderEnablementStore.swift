...
/// - **Legacy disabled-list** (`runway.disabledProviders.v1`): only the *disabled* IDs are persisted.
...
/// - **Enabled-list** (`runway.enabledProviders.v1`): only the *enabled* IDs are persisted. Fresh
...
///
/// A third set — **known provider IDs** (`runway.knownProviders.v1`) — records every provider this
...
final class ProviderEnablementStore {
    private static let disabledStorageKey = "runway.disabledProviders.v1"
    private static let enabledStorageKey = "runway.enabledProviders.v1"
    private static let knownStorageKey = "runway.knownProviders.v1"
