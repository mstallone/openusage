...
final class UpdaterController {
    ...
    func checkForUpdates() {
        ...
        // Sparkle 2.9.4 also activates dockless apps with `ignoringOtherApps`, but promote Runway
...
@MainActor
private final class RunwayUpdaterDelegate: NSObject, SPUUpdaterDelegate {
...
final class UpdaterUserDriverDelegate: NSObject, SPUStandardUserDriverDelegate {
    ...
    /// Restores Runway to its normal dockless activation policy after Sparkle finishes the session.
